...
def login_view(request):
    ...
    return redirect(keycloak_openid.auth_url(redirect_uri=settings.KEYCLOAK_REDIRECT_URI))
...
def callback_view(request):
    ...
    if code:
        ...
        token = keycloak_openid.token(code=code, redirect_uri=settings.KEYCLOAK_REDIRECT_URI)
