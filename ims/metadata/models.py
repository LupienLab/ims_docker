...
class Project(UserLog):
    ...
    ghut =  models.ForeignKey(ChoiceDisease, default=11,limit_choices_to={'class_type': "disease_site"}, related_name='disease_site', on_delete=models.CASCADE, help_text="Type of cancer")
